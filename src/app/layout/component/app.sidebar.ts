        ...
        <div class="layout-sidebar">
            <a class="layout-sidebar-brand" routerLink="/">
                <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    />
                    <mask id="sidebarBrandMask" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="8" width="54" height="11">
            ...
            <div class="layout-menu-search">
                <i class="pi pi-search layout-menu-search-icon"></i>
                <input
                    #menuSearchInput
                    type="text"
            ...
            <app-menu [searchTerm]="menuSearchTerm()"></app-menu>
        </div>
    `
})
export class AppSidebar implements OnInit, OnDestroy {
    ...
    private focusSearchInput(): void {
        const input = this.menuSearchInput?.nativeElement;
        if (!input) {
            return;
        }
